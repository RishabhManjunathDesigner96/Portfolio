    ...
    return (
        <div>
            ...
            <div id='banner_lay'>
                ...
                <Container id="about_list" >
                    <Row>
                        <Col lg={5} md={5} sm={12} >
                            <div className='why_me'>
                                <h2> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal
                                </h2>
                            </div>
                        </Col>
                        <Col lg={7} md={7} sm={12} >
                            <div className='mine_future'>
                                <h1>About Me</h1>
