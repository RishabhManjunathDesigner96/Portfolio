...
class EditContact extends React.Component {
  ...
  update = (e) => {
    ...
    if (this.state.name === "" || this.state.email === "") {
      alert("Are Sure do you want to Edit this Contact....!");
      return;
    }
    this.props.updateContactHandlar(this.state);
            ...
            <Col lg={12} md={12} sm={12}>
              ...
              <div className='form_con'>
                <Form onSubmit={this.update}>
                  ...
                  <Button variant="warning" className='btn_p' type="submit">Update</Button>
                </Form>
              </div>
            </Col>
          </Row>
